    ...
    <>
      ...
      <div className="p-4">
        ...
        <div className="mt-6 bg-white rounded shadow">
          <div className="flex flex-row sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4 p-4 justify-between">
          <h3 className="text-lg font-semibold p-4">Activities</h3>
          <div><BackButton/></div>
          </div>
          <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4 p-4">
          <button
