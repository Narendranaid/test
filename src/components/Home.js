        ...
        <div className="p-4 md:p-8 bg-black text-white">
            <div className="mb-4 md:flex md:items-center md:justify-between m-2">
                <div className="mb-4 md:mb-0 md:pr-10">
                    <h1 className="text-3xl md:text-4xl mb-2">How <b>AItGiant</b>  Works</h1>
...
const testimonials = [
  {
    ...
    avatar: t1,
    role:'Renault & Nissan',
    feedback: 'The AI training at ”AItGiant” transformed my understanding of machine learning and data science. The instructors are knowledgeable, and the curriculum is spot-on with industry needs! ',
